                            ...
                            <div class="row">
                                <div class="form-group col-md-11">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="task-title" class="form-label">ชื่อองค์กรภาษาไทย</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="billing-phone" class="form-label">เบอร์โทรองค์กร</label>
                                                <input name="phone" id="form-phone"
                                                    class="form-control form-control-light" wire:model="form-phone">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="billing-email-address"
                                                    class="form-label">อีเมลองค์กร</label>
                        ...
                        <form wire:submit.prevent="editOwnerUserData">
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <div class="mb-3">
                                        <label for="task-title" class="form-label">ชื่อองค์กรภาษาไทย</label>
                                        <input type="text" class="form-control form-control-light" id="name_th"
                                            wire:model="name_th">
                                    </div>

                                    <div class="mb-3">
                                        <label for="task-title" class="form-label">ชื่อองค์กรภาษาอังกฤษ</label>
                                        <input type="text" class="form-control form-control-light" id="name_en"
                                            wire:model="name_en">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="nametitle" class="form-select form-control-light"
                                            ...
                                            @foreach ($nametitle as $nt)
                                                <option value="{{ $nt->id }}"
                                                    wire:key="nametitle-{{ $nt->id }}">{{ $nt->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="task-title" class="form-label">ชื่อตัวแทนองค์กร</label>
                                        <input type="text" class="form-control form-control-light" id="f_name"
                                            wire:model="f_name">
                                    </div>

                                    <div class="mb-3">
                                        <label for="task-title" class="form-label">นามสกุล</label>
                                        <input type="text" class="form-control form-control-light" id="l_name"
                                            wire:model="l_name">
                                    </div>

                                    <div class="mb-3">
                                        <label for="billing-phone" class="form-label">เบอร์โทรองค์กร</label>
                                        <input name="phone" id="form-phone" class="form-control form-control-light"
                                            wire:model="form-phone">
                                    </div>

                                    <div class="mb-3">
                                        <label for="billing-email-address" class="form-label">อีเมลองค์กร</label>
                                        <input name="email" id="form-email" class="form-control form-control-light"
                                            wire:model="form-email">
                                    </div>

                                    <div class="mb-3">
                                        <label for="billing-town-city" class="form-label">บ้านเลขที่</label>
                                        <input name="no" id="form-no" class="form-control form-control-light"
                                            wire:model="form-no">
                                    </div>

                                    <div class="mb-3">
                                        <label for="billing-state" class="form-label">หมู่ที่</label>
                                        <input name="mu" id="form-mu" class="form-control form-control-light"
                                            wire:model="form-mu">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="input_amphoe" class="form-select form-control-light"
                                            ...
                                            @foreach ($amphoes as $item)
                                                <option value="{{ $item->amphoe }}"
                                                    wire:key="province-{{ $item->amphoe }}">{{ $item->amphoe }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="input_tambon" class="form-select form-control-light"
                                            ...
                                            @foreach ($tambons as $item)
                                                <option value="{{ $item->tambon }}"
                                                    wire:key="province-{{ $item->tambon }}">{{ $item->tambon }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="postcode" id="input_zipcode" class="form-control">
                                        {{-- disabled
                                            type="text" value="{{ $compa->postcode }}" wire:model="input_zipcode"> --}}
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="task-title" class="form-label">Password</label>
                                        <input name="password" id="form-password"
                                            class="form-control form-control-light" wire:model="form-Password">
                                    </div>
