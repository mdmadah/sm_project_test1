...
class AdminPERTComponent extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin-component.admin-p-e-r-t-component',['act_type'=>$act_type,'perts'=>$perts])
