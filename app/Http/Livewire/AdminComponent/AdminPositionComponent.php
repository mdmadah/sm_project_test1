...
class AdminPositionComponent extends Component
{
    use WithPagination;
    ...
    public $messages = array(
        'name.required'=>"*กรุณาป้อนตำแหน่งงาน",
        'name.max'=>"*ตำแหน่งงานไม่ควรเกิน 30 ตัวอักษร",
    );
    ...
    public function render()
    {
        ...
        return view('livewire.admin-component.admin-position-component',['positions'=>$positions])
