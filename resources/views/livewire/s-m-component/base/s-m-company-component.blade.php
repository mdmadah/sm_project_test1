    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
                            ...
                            <div class="col-lg-12">
                                <form method="POST" action="{{ route('addCompany') }}" name="editCompany-form">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="billing-first-name" class="form-label">ชื่อองค์กรภาษาอังกฤษ</label>
                                                <input name="name_en" id="form-name_en" class="form-control" readonly type="text"  value="{{$compa->name_en}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="billing-first-name" class="form-label">ชื่อองค์กรภาษาไทย</label>
                                                <input name="name_th" id="form-name_th" class="form-control" readonly type="text" value="{{$compa->name_th}}" >
                                            </div>
                                        </div>
                                    </div> <!-- end row -->
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input name="phone" id="form-phone" class="form-control" readonly type="text" value="{{$compa->phone}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="billing-phone" class="form-label">อีเมลองค์กร</label>
                                                <input name="email" id="form-email"  class="form-control" readonly type="email" value="{{$compa->email}}" >
                                            </div>
                                        </div>
                                    </div> <!-- end row -->
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input name="no" id="form-no"  class="form-control" readonly type="text" value="{{$compa->no}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="billing-state" class="form-label">หมู่ที่</label>
                                                <input name="mu" id="form-mu"  class="form-control" readonly type="text" value="{{$compa->mu}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="billing-zip-postal" class="form-label">ถนน</label>
                                                <input name="street" id="form-street"  class="form-control" readonly type="text" value="{{$compa->street}}" >
                                            </div>
                                        </div>
                                    </div> <!-- end row -->
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-control-light" disabled id="input_province" name="province" >
                                                    
                                                    @if (!is_null($compa->province))<option value="{{$compa->province}}">{{$compa->province}}</option>
                                                    @else
                                        ...
                                        <div class="col-md-4" >
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-control-light" id="input_amphoe" disabled name="amphure">
                                                    @if (!is_null($compa->amphure))<option value="{{$compa->amphure}}">{{$compa->amphure}}</option>
                                                    @else
                                        ...
                                        <div class="col-md-4" id="tambon_amphoe" >
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-control-light" id="input_tambon" disabled name="district">
                                                    
                                                    @if (!is_null($compa->district))<option value="{{$compa->district}}">{{$compa->district}}</option>
                                                    @else
                                        ...
                                        <div class="col-md-4" id="postcode_amphoe" >
                                            <div class="mb-3">
                                                ...
                                                <input name="postcode" id="input_zipcode" class="form-control" readonly type="text" value="{{$compa->postcode}}" >
                                            </div>
                                        </div>
                                    </div> <!-- end row -->
                                    <div class="text-end">
                                        <button type="button" id="edit-btn" onclick="Edit()" class="btn btn-primary" style="visibility:visible" value="แก้ไข">แก้ไข</button>
                                        <button type="submit" id="save-btn" onclick="Edit()" class="btn btn-primary" style="visibility:hidden">บันทึก</button>
            ...
            function showTambons() {
                    // let input_province = document.querySelector("#input_province");
                    let input_amphoe = document.querySelector("#input_amphoe");
                    let url = "{{ url('/api/getDistricts') }}?province="+ input_province.value + "&amphoe=" + input_amphoe.value;
                    console.log(url);        
            ...
            function showZipcode() {
                    ...
                    let input_amphoe = document.querySelector("#input_amphoe");
                    let input_tambon = document.querySelector("#input_tambon");
                    let url = "{{ url('/api/getZipcodes') }}?province=" + input_province.value + "&amphoe=" + input_amphoe.value + "&tambon=" + input_tambon.value;
                    console.log(url);        
                    // if(input_province.value == "") return;        
                    // if(input_amphoe.value == "") return;     
