...
class AdminNameTitleComponent extends Component
{
    use WithPagination;
    ...
    public function updateStatus(Request $request){
        ...
        $id = $request->id;
        Nametitle::find($id)->update(['status'=>$status]);
    ...
    public function render()
    {
        ...
        return view('livewire.admin-component.admin-name-title-component',['nametitles'=>$nametitles])
